...
--
-- Table structure for table `ActionsHistoryNew`
--
...
--
-- Dumping data for table `ActionsHistoryNew`
--

INSERT INTO `ActionsHistoryNew` (`action_id`, `user_id`, `date`, `media_id`) VALUES
(1, 3, '2021-01-19 19:04:38', 12),
(1, 3, '2021-01-19 19:13:25', 13),
(1, 3, '2021-01-19 19:23:08', 14),
(1, 3, '2021-01-19 19:24:43', 15),
(1, 3, '2021-01-19 19:26:33', 16),
(1, 3, '2021-01-19 19:28:01', 17),
(1, 3, '2021-01-19 19:30:58', 18),
(1, 3, '2021-01-19 19:33:32', 19),
(1, 3, '2021-01-19 19:35:38', 20),
(1, 3, '2021-01-19 19:38:35', 21),
(1, 3, '2021-01-19 19:42:45', 22),
(1, 3, '2021-01-19 19:44:20', 23),
(1, 3, '2021-01-19 19:46:38', 24),
(1, 3, '2021-01-19 19:48:19', 25),
(1, 3, '2021-01-19 19:52:26', 26),
(1, 3, '2021-01-19 19:53:59', 27),
(1, 3, '2021-01-19 20:13:47', 28),
(1, 3, '2021-01-19 20:14:56', 29),
(1, 3, '2021-01-19 20:16:07', 30),
(1, 3, '2021-01-19 20:18:11', 31),
(1, 3, '2021-01-19 21:17:33', 32),
(1, 3, '2021-01-19 21:18:39', 33),
(1, 3, '2021-01-19 21:20:09', 34);
...
('2014-12-31 17:00:00', 134, 12, 1, 'Nhà Xuất Bản Đại Học Quốc Gia Hà Nội', 1, 'MCBOOKS', 'Study'),
('2013-09-30 17:00:00', 228, 13, 1, 'Nhà Xuất Bản Văn Học', 1, 'Paulo', 'Truyện'),
('2020-03-19 17:00:00', 280, 14, 1, 'Nhà Xuất Bản Phụ Nữ', 1, 'Tản Văn', 'Truyện'),
('2017-12-31 17:00:00', 768, 15, 2, 'Nhà Xuất Bản Văn Học', 1, 'Nguyễn Việt Hải', 'Sách văn học'),
('2020-01-01 17:00:00', 212, 16, 1, 'Nhà Xuất Bản Thanh Niên', 1, 'V-BTS Vietnamese Fanpage', 'Truyện'),
('2020-11-30 17:00:00', 364, 17, 1, 'Nhà Xuất Bản Thế Giới', 1, 'Vãn Tình ', 'Truyện'),
('2020-04-09 17:00:00', 180, 18, 1, 'Nhà Xuất Bản Hồng Đức', 1, 'Kawabata ', 'Trinh thám'),
('2018-12-31 17:00:00', 488, 19, 1, 'KNBooks', 1, 'John Gray', 'Nhà Xuất Bản Hồng Đức'),
('2007-12-31 17:00:00', 396, 20, 1, 'MXB Trẻ', 1, 'Nguyễn Nhật Ánh', 'Truyện'),
('2018-02-28 17:00:00', 480, 21, 1, 'Nhà Xuất Bản Thế Giới', 1, 'Michio Kaku', 'Truyện');
...
('2019-12-31 17:00:00', 22, 'NHK', 'MCBook', 'CD ngoại ngữ', '10'),
('2019-12-31 17:00:00', 23, 'ABC Melody', 'ABC Singer', 'Ngoại ngữ', '10'),
('2019-12-31 17:00:00', 24, 'NXB Đai học sư phạm HCM', 'Tổng hợp', 'Ngoại ngữ', '76'),
('2019-12-31 17:00:00', 25, 'MTP ', 'Sơn Tùng', 'Nhạc giới trẻ', '20');
...
('2019-12-31 17:00:00', 0, 'None', 26, 3, 'Doraeiga', 1, NULL, 'Fujiko F Fujio'),
('2019-12-31 17:00:00', 0, 'None', 27, 3, 'Doraeiga', 1, NULL, 'Fujiko F Fujio'),
('2019-12-31 17:00:00', 0, 'None ', 28, 3, 'Doraeiga', 1, NULL, 'Fujiko F Fujio'),
('2019-12-31 17:00:00', 0, 'None ', 29, 3, 'Doraeiga', 1, NULL, 'Fujiko F Fujio'),
('2019-12-31 17:00:00', 0, 'None ', 30, 3, 'Doraeiga', 1, NULL, 'Fujiko F Fujio'),
('2019-12-31 17:00:00', 0, 'None ', 31, 1, 'Doraeiga', 1, NULL, 'Fujiko F Fujio');

-- --------------------------------------------------------

--
-- Table structure for table `DVDTypes`
--
...
--
-- Dumping data for table `DVDTypes`
--
...
--
-- Table structure for table `EGoods`
--
...
('2000-12-31 17:00:00', 32, 'US Marica ', 'MicroPro ', 'Nhạc trẻ', '10'),
('2019-12-31 17:00:00', 33, 'USA Merica Entro ', '10005-R', 'Nhạc sống động', '50'),
('2019-12-31 17:00:00', 34, 'Orchestra Accompaniment', 'Billy Jones ', 'Nhạc trẻ', '100');
...
(12, '345 Câu Khẩu Ngữ', 122000, 122000, 1, 'src/views/productImages/b1.jpg', 0),
(13, 'Nhà Giả Kim', 69000, 59000, 1, 'src/views/productImages/b2.jpg', 0),
(14, 'Vui Vẻ Không Quạu', 69000, 69000, 1, 'src/views/productImages/b3.jpg', 0),
(15, 'Hai Số Phận', 175000, 175000, 1, 'src/views/productImages/b4.jpg', 0),
(16, 'Sức mạnh ngôn từ', 96000, 96000, 1, 'src/views/productImages/b5.jpg', 0),
(17, 'Không sợ chậm', 129000, 129000, 1, 'src/views/productImages/b6.jpg', 0),
(18, 'Xứ tuyết', 60000, 60000, 1, 'src/views/productImages/b7.jpg', 0),
(19, 'Đàn Ông Sao Hỏa ', 188000, 188000, 1, 'src/views/productImages/b8.jpg', 0),
(20, 'Con chim xanh biếc', 150000, 150000, 1, 'src/views/productImages/b9.jpg', 0),
(21, 'Các thế giới song song ', 128000, 128000, 1, 'src/views/productImages/b10.jpg', 0),
(22, 'CD Tiếng Nhật Sơ Cấp', 25000, 25000, 3, 'src/views/productImages/cd1.jpg', 0),
(23, 'CD Sing & Learn Japanese', 15000, 15000, 3, 'src/views/productImages/cd2.jpg', 0),
(24, 'CD tiếng Nhật năng động', 200000, 200000, 3, 'src/views/productImages/cd3.jpg', 0),
(25, 'CD MTP ', 2000000, 2000000, 3, 'src/views/productImages/cd4.jpg', 0),
(26, 'DVD Doraemon Stand by me', 200000, 200000, 2, 'src/views/productImages/dvd1.jpg', 0),
(27, 'DVD Doraemon Movie 2011-2015', 5000000, 5000000, 2, 'src/views/productImages/dvd2.jpg', 0),
(28, 'DVD Dorreamon Ma Pháp', 500000, 500000, 2, 'src/views/productImages/dvd3.jpg', 0),
(29, 'DVD Doraemon Khủng Long', 5000000, 5000000, 2, 'src/views/productImages/dvd4.jpg', 0),
(30, 'DVD Doraemon Băng Cực ', 2000000, 2000000, 2, 'src/views/productImages/dvd5.jpg', 0),
(31, 'DVD Doraemon măt trăng', 2002000, 2002000, 2, 'src/views/productImages/dvd6.jpg', 0),
(32, 'LP Stars', 20000, 20000, 4, 'src/views/productImages/lp1.jpg', 0),
(33, 'LP Edison Record ', 20000, 20000, 4, 'src/views/productImages/lp2.jpg', 0),
(34, 'LP Vocalion', 50000000, 50000000, 4, 'src/views/productImages/lp3.jpg', 0);

-- --------------------------------------------------------

--
-- Table structure for table `MediaSales`
--
...
--
-- Dumping data for table `MediaSales`
--

INSERT INTO `MediaSales` (`sale_id`, `media_id`, `quantity`, `percent`) VALUES
(7, 13, 1, 25),
(8, 25, 4, 30);
...
CREATE TABLE `Orders` (
  ...
  `order_state_id` int(11) NOT NULL DEFAULT 3,
...
--
-- Table structure for table `PhysicalGoods`
--
...
--
-- Dumping data for table `PhysicalGoods`
--

INSERT INTO `PhysicalGoods` (`barcode`, `description`, `quantity`, `width`, `height`, `depth`, `size`, `input_day`, `media_id`, `weight`) VALUES
('2396594532736', 'Tài liệu giúp người học tự tin giao tiếp tiếng Hán qua 16 chủ đề thông dụng hàng ngày', 5, 20, 20, 20, '0', '2019-12-31 17:00:00', 12, 100),
('2518407786529', 'Tất cả những trải nghiệm trong chuyến phiêu du theo đuổi vận mệnh của mình đã giúp Santiago thấu hiểu được ý nghĩa sâu xa nhất của hạnh phúc, hòa hợp với vũ trụ và con người.', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 13, 20),
('200399', 'Cuộc đời ngày ngày nói yêu mình.\n\nXong cuộc đời lại đủ thứ phức tạp và bất công với mình.\n\nVậy là cuộc đời ghét mình rồi!\n\nThôi nào!', 5, 20, 20, 20, '0', '2020-01-19 17:00:00', 14, 20),
('20200202', '“Hai số phận” không chỉ đơn thuần là một cuốn tiểu thuyết, đây có thể xem là \"thánh kinh\" cho những người đọc và suy ngẫm, những ai không dễ dãi, không chấp nhận lối mòn.\n\n“Hai số phận” làm rung động mọi trái tim quả cảm, nó có thể làm thay đổi cả cuộc đời bạn. Đọc cuốn sách này, bạn sẽ bị chi phối bởi cá tính của hai nhân vật chính, hoặc bạn là Kane, hoặc sẽ là Abel, không thể nào nhầm lẫn. Và điều đó sẽ khiến bạn thấy được chính mình.', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 15, 20),
('0294823947', 'Bí quyết thay đổi khả năng ngôn ngữ của chính bạn!\n\nCuốn sách yêu thích của V - thành viên nhóm nhạc nổi tiếng toàn cầu BTS.\n\nLọt top những cuốn sách được đọc nhiều nhất Hàn Quốc năm 2019.\n\nLiên tục sold out trên toàn hệ thống mỗi lần tái bản.', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 16, 20),
('47289472438', 'Không Sợ Chậm Chỉ Sợ Dừng\n“Nhiều người không hiểu được vì sao một số người lại có thể sống kỷ luật như vậy. Rốt cuộc làm thế nào để họ có thể duy trì được nếp sống như thế? Họ có bí quyết gì không?\nThật ra tất cả những người có thể sống tự giác và kỷ luật đều chỉ có một lý do: Họ đã được nếm thử ‘trái ngọt’ mà sự kỷ luật đó mang lại!”\nVãn Tình được coi như “nữ hoàng” của dòng sách cảm hứng dành cho phái nữ và từng tạo nên một làn sóng thay đổi tư duy tích cực của hàng vạn phụ nữ Việt Nam qua tác phẩm Bạn đắt giá bao nhiêu?', 10, 20, 30, 10, '0', '2019-12-31 17:00:00', 17, 50),
('01923810', 'Xứ tuyết là tiểu thuyết dạng vừa đầu tiên của Kawabata Yasunari, cũng là tác phẩm đại diện cho chủ nghĩa duy mỹ ở ông.', 10, 50, 20, 10, '0', '2001-12-31 17:00:00', 18, 50),
('42427932789', 'Ngày xửa ngày xưa, những người sao Hỏa và sao Kim đã gặp gỡ, yêu nhau và sống hạnh phúc bởi họ tôn trọng và chấp nhận mọi điều khác biệt. Rồi họ đến Trái Đất và chứng lãng quên đã xảy ra: Họ quên rằng họ đến từ những hành tinh khác\n\n', 10, 20, 20, 20, '0', '2001-12-31 17:00:00', 19, 50),
('49872385986', 'Như một cuốn phim “trinh thám tình yêu”, Con chim xanh biếc bay về dẫn bạn đi hết từ bất ngờ này đến tò mò suy đoán khác, để kết thúc bằng một nỗi hân hoan vô bờ sau bao phen hồi hộp nghi kỵ đến khó thở.', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 20, 50),
('2472937489', 'Một chuyến du hành đầy trí tuệ qua các vũ trụ, được dẫn dắt tài tình bởi \"thuyền trưởng\" Michio Kaku ', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 21, 20),
('234723894', 'Đĩa CD nghe tiếng nhật sơ cấp', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 22, 20),
('487234973298', 'Vừa hát vừa học vừa nghe tiếng Nhật ', 10, 10, 10, 10, '0', '2019-12-31 17:00:00', 23, 10),
('23487923784', 'Học tiếng Nhật siêu năng động		', 10, 20, 10, 30, '0', '2019-12-31 17:00:00', 24, 40),
('872349279', 'Nhạc của Sơn Tùng MTP 	', 20, 20, 20, 20, '0', '2019-12-31 17:00:00', 25, 20),
('4823749327', 'Phim Doraemon Stand by Me	', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 26, 20),
('747294792', 'Phim Doraemon từ năm 2011-2015	', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 27, 20),
('93472394729', 'Ma pháp giới Doraemon	', 10, 20, 202, 20, '0', '2019-12-31 17:00:00', 28, 20),
('293472397', 'Những người bạn khủng long mới	', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 29, 20),
('3247329478', 'Doraemon khám phá vùng đất băng cực lạnh giá	', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 30, 20),
('8324739287', 'Doraemon khám phá mặt trăng	', 20, 20, 20, 20, '0', '2019-12-31 17:00:00', 31, 20),
('2093472973', 'LP âm nhạc Stars	', 10, 20, 20, 20, '0', '2001-12-31 17:00:00', 32, 20),
('482934732', 'Nhạc Edison Record 	', 5, 20, 20, 20, '0', '2019-12-31 17:00:00', 33, 20),
('498273498', 'Nhạc Yes ! We have no bananas 	', 10, 20, 20, 20, '0', '2019-12-31 17:00:00', 34, 500);
...
INSERT INTO `Sales` (`sale_id`, `start_day`, `end_day`) VALUES
(7, '2021-01-18 17:00:00', '2021-01-25 17:00:00'),
(8, '2021-01-18 17:00:00', '2021-01-25 17:00:00');
...
--
-- Table structure for table `TrackLists`
--
...
--
-- Indexes for table `ActionsHistoryNew`
--
...
--
-- Indexes for table `DVDTypes`
--
ALTER TABLE `DVDTypes`
  ADD PRIMARY KEY (`dvd_type_id`);

--
-- Indexes for table `EGoods`
--
ALTER TABLE `EGoods`
  ADD PRIMARY KEY (`media_id`);
...
--
-- Indexes for table `PhysicalGoods`
--
...
--
-- AUTO_INCREMENT for table `CoverTypes`
--
ALTER TABLE `CoverTypes`
  MODIFY `cover_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `DVDTypes`
--
ALTER TABLE `DVDTypes`
...
--
ALTER TABLE `Medias`
  MODIFY `media_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `OrderState`
  MODIFY `order_state_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `ShippingInfos`
  MODIFY `shipping_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- Constraints for table `ActionsHistoryNew`
--
ALTER TABLE `ActionsHistoryNew`
...
ALTER TABLE `CartItems`
  ...
  ADD CONSTRAINT `fk_CartItems_Users1` FOREIGN KEY (`user_id`) REFERENCES `Users` (`user_id`) ON DELETE CASCADE;
...
--
-- Constraints for table `MediaSales`
--
ALTER TABLE `MediaSales`
  ADD CONSTRAINT `fk_MediaSales_Medias1` FOREIGN KEY (`media_id`) REFERENCES `Medias` (`media_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_MediaSales_Sales1` FOREIGN KEY (`sale_id`) REFERENCES `Sales` (`sale_id`) ON DELETE CASCADE;

--
-- Constraints for table `OrderItems`
--
ALTER TABLE `OrderItems`
  ADD CONSTRAINT `OrderItems_ibfk_1` FOREIGN KEY (`media_id`) REFERENCES `Medias` (`media_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_OrderItems_Orders1` FOREIGN KEY (`order_id`) REFERENCES `Orders` (`order_id`) ON DELETE CASCADE;
...
--
-- Constraints for table `PhysicalGoods`
--
ALTER TABLE `PhysicalGoods`
...
--
-- Constraints for table `TrackLists`
--
ALTER TABLE `TrackLists`
